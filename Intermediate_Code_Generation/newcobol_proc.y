...
program
	: comments identification_division comments environment_division  comments data_division comments procedure_division comments
	| comments
...
environment_division 
	: tok_Environment tok_Division tok_Period comments  environment_section
	| error {printf("syntax error in environment division declaration line: %d\n", yylineno); exit(1);}
	;
 
	
environment_section 
	: environment_block environment_section 
	| 
	;
...
configuration_section 
	: tok_Configuration tok_Section tok_Period comments 
	  tok_SourceComputer tok_Period comments  tok_Identifier tok_Period comments 
	  tok_ObjectComputer tok_Period comments  tok_Identifier tok_Period comments 
	|
	;

io_section
	: tok_InputOutput tok_Section tok_Period comments  
	|
	;

file_control
	: tok_FileControl tok_Period comments 
	  tok_Select tok_Identifier tok_Assign tok_To tok_SString tok_Period comments 
	  tok_Select tok_Identifier tok_Assign tok_To tok_SString tok_Period comments 
	|
	;
	
io_control
	: tok_IOControl tok_Period comments  io_control_block
	| tok_IOControl tok_Period comments  tok_RD io_control_block
	| tok_IOControl tok_Period comments  tok_WD io_control_block
	|
	;
	
io_control_block
	: io_control_clause io_control_block
	|
	;
	
io_control_clause
	: tok_Identifier
	| tok_Assign tok_To tok_BString
	| tok_Organization tok_Is org_option
	| tok_Access tok_Is access_option
	| tok_File tok_Status tok_Is tok_Identifier
	|
	;
...
/* DATA TYPES */
data_type : tok_FloatDeclaration
	| tok_IntegerDeclaration
	| tok_AlphanumericCharacter
	| tok_AlphanumericString
	| tok_AlphabetCharacter
	| tok_AlphabeticString
	| tok_Currency
	| tok_AlphanumericCurrency
...
record_entry
    ...
    : tok_Integer  tok_Identifier  tok_PictureClause  data_type  tok_Value inc
	  tok_Period
	| tok_Integer  tok_Identifier  tok_PictureClause  data_type 
	 tok_Period
	| tok_Integer tok_Identifier array tok_PictureClause data_type tok_Period
